    ...
    content: (
      <div className="rounded-xl border border-border bg-card p-4 text-sm">
        ...
        <ol className="list-decimal space-y-1 pr-5">
          <li>0:00-0:20 — אנימציה: ארבעה עיגולים מקוננים נבנים אחד בתוך השני.</li>
          <li>0:20-1:20 — הסבר קולי על כל שכבה עם דוגמה קונקרטית (שחמט/המלצות נטפליקס/זיהוי תמונות/Claude).</li>
          <li>1:20-1:50 — תרגול חי בדיאגרמה האינטראקטיבית באתר.</li>
          <li>1:50-2:20 — חיבור קדימה: "מכאן והלאה, כל מה שנלמד בונה על ההבנה הזו".</li>
