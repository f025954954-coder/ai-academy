...
const SECTIONS: LessonSection[] = [
  { id: "slides", label: "מצגת: הפרויקט המסכם של המודול", content: <SlideDeck slides={SLIDES} /> },
  {
    ...
    content: (
      <EngineeringInsights
        why="פרויקט זה קיים כדי לתרגל את כל ה-workflows יחד על משימה אחת אמיתית — בדיוק כמו שפרויקט המודול הקודם (בטראק התכנון) שילב פרומפט מדויק+תכנון+ארכיטקטורה+פירוק."
