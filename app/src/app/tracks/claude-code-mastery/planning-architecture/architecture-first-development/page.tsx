...
const QUIZ: QuizQuestion[] = [
  {
    ...
    optionNotes: [
      "לא נכון: זה בדיוק ההפך ממה שהשיעור ממליץ עליו — מסמך ארכיטקטורה ענק לכל שינוי הוא overhead שהשיעור מזהיר מפניו.",
      "התשובה הנכונה: architecture-first פירושו לקבוע קודם 'מה נכנס ומה יוצא' (הטיפוסים/הממשק), ורק אז לתת לסוכן למלא את הלוגיקה הפנימית שמיישמת את החוזה הזה.",
      "לא נכון: זה בדיוק ההפך — architecture-first אומר שאתה, המפתח, קובע את הצורה מראש, ולא משאיר את זה לגמרי לשיקול הדעת של הסוכן.",
      "לא נכון: אין קשר בין הרעיון הזה לבחירת שפת תכנות — architecture-first ישים בכל שפה, כולל TypeScript שבו למעשה קל יותר ליישם אותו (בעזרת טיפוסים).",
    ],
  },
  {
    id: "q2",
    ...
    optionNotes: [
      "לא נכון: AI לא 'מבולגן מטבעו' — הבעיה ספציפית וניתנת למניעה: היעדר חוזה מוסכם לחזור אליו בכל בקשה חדשה.",
      "התשובה הנכונה: בלי חוזה קבוע, לכל feature חדש 'אין למה לחזור' — הסוכן ממציא מבנה סביר משלו בכל פעם, וזה מצטבר לחוסר עקביות.",
      "לא נכון: זו לא תופעה אקראית — יש לה סיבה שיטתית וברורה (היעדר חוזה), ולכן גם פתרון שיטתי (הגדרת חוזה מראש).",
      "לא נכון: התופעה קיימת גם בפרויקטים קטנים — היא מחמירה עם הגודל, אבל לא תלויה בו כתנאי הכרחי.",
    ],
  },
];
