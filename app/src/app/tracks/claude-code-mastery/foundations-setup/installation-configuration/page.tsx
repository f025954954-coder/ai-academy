...
const QUIZ: QuizQuestion[] = [
  {
    ...
    correctIndex: 1,
    explanation: "הגדרות פרויקט משותפות לצוות דרך git; הגדרות גלובליות הן העדפה אישית שלך שחלה בכל מקום.",
  },
  {
    id: "q2",
    ...
    correctIndex: 1,
    explanation: "אלו כלים משלימים, לא מתחרים — הבחירה תלויה בסוג המשימה הנוכחית.",
  },
];
