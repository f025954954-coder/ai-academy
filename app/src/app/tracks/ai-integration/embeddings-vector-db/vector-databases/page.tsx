  ...
  },
  {
    ...
    content: (
      <EngineeringInsights
        ...
        whenNotTo="לכמות קטנה של וקטורים (מאות בודדות, כמו מאמרי עזרה של מוצר קטן) — even בלי אינדקס בכלל, חיפוש ליניארי מהיר מספיק. אין טעם להוסיף מורכבות לפני שיש בעיה אמיתית."
        commonMistakes="להוסיף אינדקס וקטורי לפני שיש בכלל מספיק נתונים כדי להצדיק אותו — אינדקס על 50 שורות הוא בזבוז, לא אופטימיזציה."
        cost="אינדקסים וקטוריים תופסים מקום דיסק נוסף ומאטים מעט כתיבות (כי צריך לעדכן את האינדקס) — פשרה נוספת שצריך לקחת בחשבון, לא רק יתרון חד-צדדי."
