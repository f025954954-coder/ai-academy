    ...
    content: (
      <div className="rounded-xl border border-border bg-card p-4 text-sm">
        ...
        <ol className="list-decimal space-y-1 pr-5">
          <li>0:00-0:25 — אנימציה: מסעדה שוב — הלקוח מזמין, המטבח (שרת) מכין, המלצר מגיש.</li>
          <li>0:25-1:10 — פיצול מסך: צד לקוח (רינדור, אינטראקציה) מול צד שרת (לוגיקה, DB).</li>
          <li>1:10-1:50 — הדגמה חיה: משחק "מי עושה מה" באתר.</li>
          <li>1:50-2:30 — אנימציית מחזור חיים מלא, מסונכרן עם הדיאגרמה.</li>
