    ...
    content: (
      <div className="rounded-xl border border-border bg-card p-4 text-sm">
        ...
        <ol className="list-decimal space-y-1 pr-5">
          <li>0:00-0:20 — אנימציה: מכתב באנגלית שצריך תרגום למחשב שמבין רק 0/1.</li>
          <li>0:20-1:10 — פיצול מסך: קומפיילר (כל הטקסט מתורגם בבת אחת) מול אינטרפרטר (שורה-שורה).</li>
          <li>1:10-1:50 — הדגמת מסך: הרצת אותה פונקציה בעורך הקוד החי באתר.</li>
          <li>1:50-2:30 — אנימציית JIT: קוד &quot;חם&quot; נדלק באדום ומואץ.</li>
          <li>2:30-2:50 — סיכום + כתוביות.</li>
        </ol>
      </div>
    ),
  },
