    ...
    content: (
      <div className="rounded-xl border border-border bg-card p-4 text-sm">
        ...
        <ol className="list-decimal space-y-1 pr-5">
          <li>0:00-0:30 — אנימציה: נורה שנדלקת/כבית (1/0) הופכת לרצף ביטים.</li>
          <li>0:30-1:15 — מוטיון גרפיקס: 8 ביטים מתחברים לבייט, טבלת המרה לעשרוני.</li>
          <li>1:15-2:00 — הדגמת מסך בסימולטור הממיר החי באתר.</li>
          <li>2:00-2:40 — אנימציה: פיקסלים בונים תמונה, גל קול נדגם לנקודות.</li>
