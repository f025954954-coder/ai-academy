...
export const TRACKS: TrackSummary[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { slug: "planning-architecture", title: "חשיבה לפני קוד: תכנון וארכיטקטורה", description: "prompt design, planning, architecture-first, decomposition", projectBrief: "תוכנית ארכיטקטורה + מימוש פיצ'ר ב-AtlasDesk", lessons: [] },
