...
export const TRACKS: TrackSummary[] = [
  ...
  },
  {
    ...
    modules: [
      {
        slug: "saas-planning",
        title: "תכנון מוצר SaaS AI",
        description: "מיפוי משתמשים, תמחור, MVP",
        projectBrief: "מסמך MVP מלא ל-AtlasDesk כמוצר מסחרי",
        lessons: [
          {
            slug: "user-mapping-and-personas",
          ...
          {
            slug: "pricing-strategy-for-ai-saas",
          ...
          {
            slug: "project-atlasdesk-mvp-document",
      ...
      },
      {
        slug: "saas-build",
        title: "בנייה מלאה",
        description: "שילוב כל מה שנלמד",
        projectBrief: "AtlasDesk מקבל שכבת הרשאות בסיסית",
        lessons: [
          {
            slug: "multi-tenancy-fundamentals",
          ...
          {
            slug: "project-atlasdesk-basic-access-control",
      ...
      {
        slug: "saas-business",
        title: "עסקי: billing ואונבורדינג",
        description: "subscriptions, analytics",
        projectBrief: "סימולציית חיוב ואונבורדינג ל-AtlasDesk",
        lessons: [
          {
            slug: "subscription-billing-concepts",
          ...
          {
            slug: "onboarding-and-activation",
      ...
      },
      {
        slug: "saas-launch",
        title: "השקה",
        description: "דיפלוי, ניטור, שיווק טכני",
        projectBrief: "קפסטון סופי: AtlasDesk מוכן להשקה",
        lessons: [
          {
          ...
          {
            slug: "capstone-academy-synthesis",
